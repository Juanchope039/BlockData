...
public class Interface {
    ...
    private static void pruebaenviomensages() {
            ...
            Mensaje msg2 = new Mensaje(llavepublicaE, llaveprivadaE, llavepublicaR,  /*"#"*/lector.nextLine());
            msg2.prueba();
            //if (msg2.ComprobarMensage())
            //    Manejador_de_Base_de_Datos.enviarmensage(msg2);
    }

    private static void pruebarecibirmensajes() {
        String llavepublicaE = "";
        ArrayList<Mensaje> msgs = Manejador_de_Base_de_Datos.recibirmensage(llavepublicaE);//"hola diana"
...
//            Destinatarios.add(msg.DecifrarMensage());//*/
    ...
    private static void prueba_dechat() {
        String prv = "", pub = "", pube = "", mensaje = "", pubr = "",texto = "", firma = "";
        RSAChat chat = new RSAChat(2048,256, prv, pub);
        chat.Write(pube,mensaje);
        chat.read(pubr,texto,firma);
