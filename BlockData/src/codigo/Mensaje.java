...
public final class Mensaje implements Serializable{
    ...
    public Mensaje(String msg){
        generarLlaves();
        CargarLlavepubR(getLlavePublicaEmissor());
        generarLlaves();
        mensage = msg;
    ...
    public Mensaje(String pubR, String msg) {
        generarLlaves();
    ...
    public Mensaje(String pubE, String prvE, String pubR, String msg) {
    ...
    public Mensaje(String pubE, String pubR, String prvR, String msg, String FirmaDigital){
    ...
    public boolean ComprobarMensage(){
        return gethashMensage().equals(DecifrarFirma());
    }
    ...
    public static void main(String[] args) {
        ...
        //while (Lector.hasNext()) {
            String pubR = "",
                ...
                mensage = Lector.next();
            Mensaje msg = new Mensaje(pubE, prvE, pubR, mensage);
    ...
    public String hash() {
        if (ComprobarMensage()){
            String salida = getLlavePublicaEmissor() + getLlavepublicaReceptor() + 
            mensageCifrado + FirmaDigital + hasAnterior;
    ...
    public String getMensageCifrado(){
    ...
    public String getLlavePublicaEmissor() {
        return rsa.getLlave(llavePublicaE);
    }
    
    public String getLLavePrivadaEmissor() {
        return rsa.getLlave(llavePrivadaE);
    }
    ...
    private void generarLlaves() {
        try {
            ...
            pardeLlaves.initialize(2048);
            KeyPair keyPair = pardeLlaves.generateKeyPair();
            llavePrivadaE = keyPair.getPrivate();
            llavePublicaE = keyPair.getPublic();
